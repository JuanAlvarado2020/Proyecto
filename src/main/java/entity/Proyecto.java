...
public class Proyecto {
    ...
    private String detalleArrrastre;
    ...
    public String getDetalleArrrastre() {
        return detalleArrrastre;
    }

    public void setDetalleArrrastre(String detalleArrrastre) {
        this.detalleArrrastre = detalleArrrastre;
    }
